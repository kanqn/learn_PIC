...
### CLRWDT命令(cleat watchdog timer)
PICにはウォッチドッグタイマというタイマが内蔵されていて  
これはプログラムが異常になったことを検知するためにあり、CLRWDTはウォッチドッグタイマをクリアしてタイムアップさせないための命令である。  
...
#### 送信中ビジー
・ビジー: 処理中で他の処理を受け付けない状態  
・送信中: まだデータの送信が完了していない状態  
